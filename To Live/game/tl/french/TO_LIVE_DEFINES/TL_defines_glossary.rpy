...
translate french strings:
    ...
    # game/TO_LIVE_DEFINES/TL_defines_glossary.rpy:24
    old "Tao Te Ch'ing is a Chinese classic text traditionally credited to the 6th-century BC sage Laozi. It is one of the two fundamental for both philosophical and religious Taoism."
    new ""
    ...
    # game/TO_LIVE_DEFINES/TL_defines_glossary.rpy:24
    old "Guizi is a pejorative Chinese slang term for foreigners, and has had a history of containing xenophobic connotations. During world war two this was used to refer to the Japanese invaders."
    new ""
    ...
    # game/TO_LIVE_DEFINES/TL_defines_glossary.rpy:24
    old "Romanized as \"Dong Bei\" this just means north east and generally defines the Manchurian territory. These normally include the provinces of Heilongjiang, Liaoning, Jilin and a portion of Inner Mongolia."
    new ""
