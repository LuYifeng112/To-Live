...
init -10 python:          
    ...
    TL_GUO[21] = Nation(__("Kingdom of Ngolok"), "KON", __("Ngolok Tribes"), __("Ngolok Tibetan Insurgents"), __("Independance Uprising"), __("Non-Aligned"), __("Ngolok Tribes"), __("No Faction"), True, False, "country_flag/KON.png", "")
