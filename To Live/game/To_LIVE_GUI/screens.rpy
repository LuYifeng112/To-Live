...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("Historical Events") action ShowMenu("historical_event_log")

        textbutton _("Poems") action ShowMenu("poems")

        textbutton _("Pinyin GLossary") action ShowMenu("glossary")
...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot (134, 148, 442, 656) hovered Play("sound", "sounds/menu/select_flip.ogg") clicked Start()
        hotspot (635, 202, 417, 579):
            if persistent.ironman:
                pass
            else:
                action ShowMenu("load")
        hotspot (1147, 102, 649, 432) hovered Play("sound", "sounds/menu/page_turn.ogg") clicked ShowMenu("preferences")
        hotspot (1175, 590, 581, 420) hovered Play("sound", "sounds/menu/select_flip.ogg") clicked ShowMenu("quit") 
        hotspot (61, 842, 528, 171) hovered Play("sound", "sounds/menu/page_turn.ogg") clicked ShowMenu("glossary")
        hotspot (642, 833, 459, 247) hovered Play("sound", "sounds/menu/hotspot_hover.ogg") clicked ShowMenu("historical_event_log")
    
    #timer 50 action Jump("Pre_Menu") #when left alone for 50 seconds, it jumps to the opening label.
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("Game Type")
                    textbutton _("Permanent Revolution") action SetField(persistent, "ironman", True)
                    textbutton _("Recite and Learn") action SetField(persistent, "ironman", False)
...
screen keyboard_help():
    ...
    hbox:
        label "G"
        text _("Toggles the visibility of the glossary tab to see what certain words mean.")
    ...
    hbox:
        label "L"
        text _("Toggles the visibility of the historical events log tab to see what battles and events happen in the story to their real life counterparts.")
    hbox:
        label "N"
        text _("Toggles the visibility of the National Map where you can see cities and information on the countries of the time period.")
    hbox:
        label "P"
        text _("Toggles the visibility of the Poems Tab to see some poems you have unlocked throughout the game.")
    hbox:
        label "S"
...
screen quit():
    ...
    text _("{b}Game Progress: [result]%{/b}") size 30 xalign 0.7 yalign 0.65 color "#031a68"
